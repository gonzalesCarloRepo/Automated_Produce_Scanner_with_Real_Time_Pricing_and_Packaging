...
# USER SETTINGS
# ==========================================
SAVE_DIR = "/home/pi/captured_images_ver2_zoom"   # Editable save path
CAPTURE_WIDTH = 720                              # Editable capture width
CAPTURE_HEIGHT = 640                              # Editable capture height
    ...
    try:
        while True:
            ...
            lines = [
                ...
                "k=start  s=stop  z/x=fine zoom  a/d=coarse zoom  0=reset  q=quit"
            ]
