...
# =========================================================
DEFAULT_SAVE_DIR = "/home/jekaca/hopefully_final_datasets/artificial_light/onion_h4"
DEFAULT_FILE_PREFIX = "onion_h4"
...
class ManualCameraApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Camera_Ver_1 - Manual Capture")
    ...
    def _build_ui(self):
        ...
        info_label = tk.Label(
            left,
            text="Keyboard:  k = capture once   |   q = quit",
            bg="#1f1f1f",
            fg="white",
            font=("Arial", 11)
        )
        ...
        delay_frame = tk.Frame(right, bg="#2b2b2b")
        delay_frame.pack(fill="x", padx=12, pady=6)
        tk.Label(delay_frame, text="Countdown before capture (seconds)", bg="#2b2b2b", fg="white").pack(anchor="w")
        tk.Spinbox(delay_frame, from_=0, to=60, textvariable=self.delay_var, width=10).pack(anchor="w", pady=(4, 0))
